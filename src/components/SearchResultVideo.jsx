  ...
  return (
    <Link to={`/video/${video?.videoId}`}>
      <div className="flex flex-col mb-8 md:flex-row md:mb-3 lg:hover:bg-white/[0.1] rounded-xl md:p-4 ">
        <div className="relative flex w-full h-48 overflow-hidden shrink-0 md:h-28 lg:h-40 xl:h-48 md:w-48 lg:w-64 xl:w-80 rounded-xl bg-slate-800">
          <img
        ...
        <div className="flex flex-col mt-4 ml-4 overflow-hidden md:ml-6 md:mt-0">
          ...
          <div className="items-center hidden md:flex">
            ...
            <div className="flex flex-col">
              ...
              <div className="flex truncate overflow-hidden text-sm font-semibold text-white/[0.7]">
